    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-black/50 px-4 py-8 backdrop-blur-sm",
            className,
          )}
        >
          {children}
  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
              <span className="font-medium text-white">Laksh</span>
    </a>
  );
};
