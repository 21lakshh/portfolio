...
export default function AskMeClient() {
  return (
    <div className="min-h-screen w-full bg-white dark:bg-black">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <p className="text-neutral-600 dark:text-neutral-400 text-lg sm:text-xl md:text-2xl text-center max-w-3xl mx-auto leading-relaxed">
                Have questions about my experience, projects, or skills? Ask away!
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* Section Transition */}
      <div className="w-full h-8 sm:h-12 lg:h-16 bg-gradient-to-b from-neutral-50/30 dark:from-neutral-900/30 to-white dark:to-black"></div>

      {/* Chat Interface */}
      <div className="px-6 sm:px-8 md:px-16 lg:px-20 py-12 sm:py-16">
        <div className="max-w-4xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
