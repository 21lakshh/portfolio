...
const techStack = [
  ...
  { name: "NestJS", category: "framework", icon: "/tech-icons/Nest.js.svg", color: "bg-gray-500" },
  ...
  { name: "Prisma", category: "database", icon: "/tech-icons/prisma.svg", color: "bg-gray-500" },
  { name: "Supabase", category: "database", icon: "/tech-icons/supabase.svg", color: "bg-gray-500" },
  
  // AI & ML Tools
  { name: "LangChain", category: "ai", icon: "/tech-icons/langchain.svg", color: "bg-gray-500" },
  { name: "LangGraph", category: "ai", icon: "/tech-icons/langgraph.svg", color: "bg-gray-500" },
  ...
  { name: "Vercel", category: "tool", icon: "/tech-icons/vercel.svg", color: "bg-gray-500" },
  { name: "Cloudflare Workers", category: "tool", icon: "/tech-icons/cloudflareworkers.svg", color: "bg-gray-500" },
  { name: "LiveKit", category: "tool", icon: "/tech-icons/livekit.svg", color: "bg-gray-500" },
];
